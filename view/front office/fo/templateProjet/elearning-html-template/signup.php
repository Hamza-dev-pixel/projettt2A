...
<div class="login-container">
    ...
    <form id="signup-form" onsubmit="return validateForm()">
        <div class="input-group">
            ...
            <select id="user-type" onchange="toggleFields()">
        ...
        <div id="etudiant-fields" style="display: none;">
            <div class="input-group">
                ...
                <input type="text" id="date_naissance" name="date_naissance" placeholder="yyyy-mm-dd" required>
            </div>
            <div class="input-group">
        ...
        <div id="prof-fields" style="display: none;">
            ...
            <div class="input-group">
                ...
                <input type "email-prof" name ="email-prof required >
            </div >
        </ div >
