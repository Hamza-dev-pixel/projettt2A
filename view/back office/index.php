        ...
        <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              <p class="mb-0 font-weight-medium me-3 buy-now-text">Modifier , Ajout et suppression des utulisateurs</p>
              <a href="" target="_blank" class="btn me-2 buy-now-btn border-0">Uniboard</a>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="userlist.php"> enseignant </a></li>
            </ul>
          </div>
        </li>
      </ul>
...
        </div>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item">
              <h4 class="mb-0 font-weight-bold d-none d-xl-block">vendredi NOV 2024 </h4>
            </li>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content flex-grow">
                    <h6 class="preview-subject ellipsis font-weight-normal">slim
                    </h6>
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content flex-grow">
                    <h6 class="preview-subject ellipsis font-weight-normal">aymen
                    </h6>
                    <p class="font-weight-light small-text text-muted mb-0">
                      j'ai un probléme dans mon cours
                    </p>
                  </div>
                </a>
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content flex-grow">
                    <h6 class="preview-subject ellipsis font-weight-normal"> asma
                    </h6>
                    <p class="font-weight-light small-text text-muted mb-0">
